              ...
              {isViewOnly ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#E21A23] text-white text-sm font-medium hover:bg-[#B8131A] transition-colors"
                  >
        ...
        <div className="bg-[var(--card)] rounded-xl border border-[var(--border)] overflow-hidden animate-slideUp" style={{ animationDelay: "400ms" }}>
          ...
          <div className="px-5 py-4 border-t border-[var(--border)] flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="px-3 py-1.5 rounded-lg text-sm bg-[#E21A23] text-white">
                1
              </button>
