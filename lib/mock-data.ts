export type Product = "Platform 1" | "Platform 2" | "Platform 3" | "Platform 3" | "Platform 4";
...
export const reports: Report[] = [
  // Platform 1 Reports
  {
    ...
    description: "Overview of student enrollments across all Platform 1 courses, including enrollment trends and course capacity utilization.",
    product: "Platform 1",
  ...
  // Platform 2 Reports
  {
    ...
    description: "Student progress through Platform 2 learning paths with topic mastery and time-on-task metrics.",
    product: "Platform 2",
    lastGenerated: new Date("2026-01-18"),
    availableFormats: ["csv", "xlsx", "both"],
    category: "Performance",
  },
  {
    ...
    description: "Detailed breakdown of student mastery levels across all Platform 2 topics and skill areas.",
    product: "Platform 2",
  ...
  },
  {
    ...
    description: "Analysis of student time spent in Platform 2 including productive learning time and session patterns.",
    product: "Platform 2",
  ...
  // Platform 3 Reports
  {
    ...
    description: "Overview of student performance on Platform 3 skills assessments across Microsoft Office applications.",
    product: "Platform 3",
  ...
  // Platform 4 Reports
  {
    ...
    description: "Platform 4 engagement including video views, practice problem attempts, and study session data.",
    product: "Platform 4",
  ...
  },
  {
    ...
    description: "Analysis of learning outcomes and skill improvement metrics from Platform 4 activities.",
    product: "Platform 4",
    lastGenerated: null,
    availableFormats: ["csv", "xlsx", "both"],
    category: "Performance",
...
export function getEnrollmentDashboardStats() {
  ...
  return {
    ...
    byProduct: {
      "Platform 1": { count: connectStudents, percentage: Math.round((connectStudents / totalStudents) * 100) },
      "Platform 2": { count: aleksStudents, percentage: Math.round((aleksStudents / totalStudents) * 100) },
      "Platform 3": { count: simnetStudents, percentage: Math.round((simnetStudents / totalStudents) * 100) },
    },
  };
}
...
export const allProducts: Product[] = ["Platform 1", "Platform 2", "Platform 3", "Platform 4"];
...
export const rolePresets: RolePresetConfig[] = [
  {
    ...
    defaultProducts: ["Platform 1", "Platform 2", "Platform 3", "Platform 4"],
  },
  {
    id: "licenses_manager",
  ...
  },
  {
    ...
    defaultProducts: ["Platform 1", "Platform 2", "Platform 3"],
  },
  {
    id: "full_admin",
...
export const adminUsers: AdminUser[] = [
  {
    ...
    status: "active",
    productAccess: {
      reports: ["Platform 1", "Platform 2", "Platform 3", "Platform 4"],
      licenses: ["Platform 1", "Platform 2", "Platform 3", "Platform 4"],
      enrollment: ["Platform 1", "Platform 2", "Platform 3", "Platform 4"],
    },
  },
  {
    id: "user-2",
    ...
    status: "active",
    productAccess: {
      reports: ["Platform 1", "Platform 2", "Platform 3"],
      licenses: ["Platform 1", "Platform 2", "Platform 3"],
      enrollment: [],
    },
  },
  {
  ...
  },
  {
    ...
    productAccess: {
      reports: ["Platform 1", "Platform 2"],
      licenses: [],
      enrollment: ["Platform 1", "Platform 2", "Platform 3"],
    },
  },
  {
    id: "user-5",
